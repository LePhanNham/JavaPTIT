...
class NhanVien2 {
    ...
    public NhanVien2(String id, String name, long luongngay, long songay, String chucvu) {
        this.id = id;
        this.name = name;
...
public class J05040_LapBangTinhCong {
    public static void main(String[] args) {
        ...
        for (int i=1;i<=t;i++ ) {
            arr.add(new NhanVien2(String.format("NV%02d",i),sc.nextLine(),Long.parseLong(sc.nextLine()),Long.parseLong(sc.nextLine()),sc.nextLine()));
        }
